							...
							<div class="col-lg-4">
								<div class="card">
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="{{ (!empty($vendor->photo)) ? url('adminbackend/upload/vendor_profile/'.$vendor->photo):url('adminbackend/no_image.jpg') }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                            <div class="mt-3">
                                                <h4>{{ $vendor->name }}</h4>
		...
		<div class="card-body">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="text" name="username"  class="form-control" value="{{ $vendor->username }}"  />
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<input type="file" name="photo"  class="form-control" id="image" name="image"  />
				</div>
			</div>
            <div class="row mb-3">
				<div class="col-sm-3">
				...
				<div class="col-sm-9 text-secondary">
					 <img id="showImage" src="{{ (!empty($vendor->photo)) ? url('adminbackend/upload/vendor_profile/'.$vendor->photo):url('adminbackend/no_image.jpg') }}" alt="Vendor" style="width:100px; height: 100px;"  >
				</div>
			</div>
