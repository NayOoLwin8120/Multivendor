...
@section('main')
       ...
       @include('front_end.body.homeslider')
        <!--End hero slider-->

        <!--Start  category slider-->
        @include('front_end.body.feature_category')
        <!--End category slider-->
       ...
       {{-- Start new products --}}
       @include('front_end.body.new_products')
       {{-- End new products --}}
        <!--Products Tabs-->
        ...
        @include('front_end.body.feature_products')
        ...
        <!--Vendor List -->
        @include('front_end.body.vendor_list')
        <!--End Vendor List -->
@endsection
